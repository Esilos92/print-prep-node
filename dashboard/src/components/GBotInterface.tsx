  ...
  return (
    <div className="cyber-panel">
      <div style={{ padding: '12px' }}>
        ...
        {/* Headers Row - matching JobHistory pattern */}
        <div style={{ display: 'flex', flexDirection: 'row', marginBottom: '16px' }}>
          <div style={{ width: '50%', paddingRight: '16px' }}>
            <div className="flex items-center gap-2 mb-2">
              <Bot className="w-6 h-6 text-blue-400" />
              <h3 className="font-cyber text-xl text-glow-blue">GBot.EXE</h3>
            </div>
        ...
        {/* Content Row */}
        <div style={{ display: 'flex', flexDirection: 'row', height: 'calc(100% - 80px)' }}>
          ...
          <div style={{ width: '50%', paddingLeft: '16px' }}>
            {/* Chat Container */}
            <div className="bg-slate-900/80 rounded-lg border border-slate-600 flex flex-col overflow-hidden" style={{ height: '100%' }}>
